...
router.get("/", (req, res) => {
  // Fetch all 12 columns from the first row of the android_development table
  const query =
    "SELECT Term1, Description1, Term2, Description2, Term3, Description3, Term4, Description4, Term5, Description5, Term6, Description6 FROM android_development LIMIT 1";
